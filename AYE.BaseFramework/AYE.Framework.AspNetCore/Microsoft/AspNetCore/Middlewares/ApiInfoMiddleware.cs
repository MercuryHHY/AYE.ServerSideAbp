...
using Volo.Abp.Json;
using AYE.Framework.Core.Extensions;
using static System.Net.WebRequestMethods;

namespace AYE.Framework.AspNetCore.Microsoft.AspNetCore.Middlewares
{
...
&& context.Response.Headers["Content-Type"].ToString() == "application/vnd.ms-excel")
                {
                    ...
                    context1.FileAttachmentHandle($"{DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss")}.xlsx");
                }
